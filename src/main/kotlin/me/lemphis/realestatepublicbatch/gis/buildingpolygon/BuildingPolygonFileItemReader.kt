...
class BuildingPolygonFileItemReader {
	...
	private fun buildingPolygonFileItemReaderDelegate() =
		object : ResourceAwareItemReaderItemStream<BuildingPolygonFileSpec> {
			...
			override fun read(): BuildingPolygonFileSpec? {
				if (featureIterator.hasNext()) {
					++readCount
					return toBuildingPolygonSpec(featureIterator.next())
				}
				return null
			}

			fun toBuildingPolygonSpec(feature: SimpleFeature) = BuildingPolygonFileSpec(
