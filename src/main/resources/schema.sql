...
(
    ...
    KEY `ix-summary-관리상위건축물대장PK` (`관리상위건축물대장PK`),
    KEY `ix-summary-시군구코드-법정동코드-번-지` (`시군구코드`, `법정동코드`, `번`, `지`)
) ENGINE = InnoDB
...
(
    ...
    `대지면적`       DECIMAL(19, 9) DEFAULT NULL COMMENT '대지면적 [DECIMAL(19,9)]',
    `건축면적`       DECIMAL(19, 9) DEFAULT NULL COMMENT '건축면적 [DECIMAL(19,9)]',
    `건폐율`        DECIMAL(19, 9) DEFAULT NULL COMMENT '건폐율 [DECIMAL(19,9)]',
    `연면적`        DECIMAL(19, 9) DEFAULT NULL COMMENT '연면적 [DECIMAL(19,9)]',
    `용적률산정연면적`   DECIMAL(19, 9) DEFAULT NULL COMMENT '용적률산정연면적 [DECIMAL(19,9)]',
    `용적률`        DECIMAL(19, 9) DEFAULT NULL COMMENT '용적률 [DECIMAL(19,9)]',
    ...
    `세대수`        INTEGER        DEFAULT NULL COMMENT '세대수 [NUMERIC(5)]',
    `가구수`        INTEGER        DEFAULT NULL COMMENT '가구수 [NUMERIC(5)]',
    `높이`         DECIMAL(19, 9) DEFAULT NULL COMMENT '높이 [DECIMAL(19,9)]',
    ...
    `부속건축물수`     INTEGER        DEFAULT NULL COMMENT '부속건축물수 [NUMERIC(5)]',
    `부속건축물면적`    DECIMAL(19, 9) DEFAULT NULL COMMENT '부속건축물면적 [DECIMAL(19,9)]',
    `총동연면적`      DECIMAL(19, 9) DEFAULT NULL COMMENT '총동연면적 [DECIMAL(19,9)]',
    `옥내기계식대수`    INTEGER        DEFAULT NULL COMMENT '옥내기계식대수 [NUMERIC(6)]',
    `옥내기계식면적`    DECIMAL(19, 9) DEFAULT NULL COMMENT '옥내기계식면적 [DECIMAL(19,9)]',
    `옥외기계식대수`    INTEGER        DEFAULT NULL COMMENT '옥외기계식대수 [NUMERIC(6)]',
    `옥외기계식면적`    DECIMAL(19, 9) DEFAULT NULL COMMENT '옥외기계식면적 [DECIMAL(19,9)]',
    `옥내자주식대수`    INTEGER        DEFAULT NULL COMMENT '옥내자주식대수 [NUMERIC(6)]',
    `옥내자주식면적`    DECIMAL(19, 9) DEFAULT NULL COMMENT '옥내자주식면적 [DECIMAL(19,9)]',
    `옥외자주식대수`    INTEGER        DEFAULT NULL COMMENT '옥외자주식대수 [NUMERIC(6)]',
    `옥외자주식면적`    DECIMAL(19, 9) DEFAULT NULL COMMENT '옥외자주식면적 [DECIMAL(19,9)]',
    `허가일`        VARCHAR(8)     DEFAULT NULL COMMENT '허가일 [VARCHAR(8)]',
    `착공일`        VARCHAR(8)     DEFAULT NULL COMMENT '착공일 [VARCHAR(8)]',
    `사용승인일`      VARCHAR(8)     DEFAULT NULL COMMENT '사용승인일 [VARCHAR(8)]',
    `허가번호년`      VARCHAR(4)     DEFAULT NULL COMMENT '허가번호년 [VARCHAR(4)]',
    ...
    `호수`         INTEGER        DEFAULT NULL COMMENT '호수 [NUMERIC(5)]',
    `에너지효율등급`    VARCHAR(4)     DEFAULT NULL COMMENT '에너지효율등급 [VARCHAR(4)]',
    `에너지절감율`     DECIMAL(19, 9) DEFAULT NULL COMMENT '에너지절감율 [DECIMAL(19,9)]',
    `에너지EPI점수`   INTEGER        DEFAULT NULL COMMENT '에너지EPI점수 [NUMERIC(5)]',
    `친환경건축물등급`   CHAR(1)        DEFAULT NULL COMMENT '친환경건축물등급 [CHAR(1)]',
    `친환경건축물인증점수` INTEGER        DEFAULT NULL COMMENT '친환경건축물인증점수 [NUMERIC(5)]',
    `지능형건축물등급`   CHAR(1)        DEFAULT NULL COMMENT '지능형건축물등급 [CHAR(1)]',
